...
import { USER_ROLE_LABELS, UserRole, ApprovalStatus } from '@/lib/types/nexus';
...
export default function TIConsolePage() {
  ...
  const [activeTab, setActiveTab] = useState<'ROLES' | 'APPROVALS' | 'TELEMETRY'>('ROLES');
  ...
  return (
    <div className="min-h-full flex flex-col bg-white dark:bg-[#0B120E] rounded-2xl border border-slate-200 dark:border-[#1E3125] shadow-xs relative select-none font-sans p-3 sm:p-4 space-y-4 transition-colors duration-200">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-600 dark:text-slate-400 font-sans">
              Gestão de privilégios RLS, alocação de cargos e esteira de aprovação da Diretoria de TI.
            </p>
          </div>
        </div>
      ...
      {/* Navigation Tabs */}
      <div className="flex items-center space-x-2 border-b border-slate-200 dark:border-[#1E3125] pb-2">
        <button
        ...
        >
          ...
          <span>🔑 Matriz de Cargos & IAM</span>
        </button>
        ...
        >
          ...
          <span>🛡️ Fila de Aprovações da Diretoria TI</span>
        ...
        >
          ...
          <span>🖥️ Telemetria de Sistemas</span>
        </button>
      </div>
