...
export default function AdminSimulacaoPage() {
  ...
  return (
    <div className="space-y-4 max-w-7xl mx-auto text-xs">
      {/* Header Bar */}
      <div className="flex items-center space-x-3 bg-white dark:bg-[#121D16] border border-[#E2E8E3] dark:border-[#1E3125]/90 p-4 rounded-lg shadow-sm">
        <div className="p-2 bg-slate-800 border border-slate-700 text-[#1A281E] dark:text-slate-100 rounded">
          <PlayCircle className="w-5 h-5" />
        </div>
        <div>
          <h1 className="text-base font-bold text-[#1A281E] dark:text-slate-100 font-sans tracking-tight">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        {/* 07:00 */}
        <div className="bg-white dark:bg-[#121D16] border border-[#E2E8E3] dark:border-[#1E3125]/90 p-4 rounded-lg shadow-sm space-y-2 flex flex-col justify-between">
          <div>
            <span className="text-[10px] font-mono font-bold text-slate-300 bg-slate-950 px-2 py-0.5 rounded border border-slate-800">
              07:00
            </span>
            <h3 className="font-bold text-[#1A281E] dark:text-slate-100 mt-2">Início do Dia (07:00)</h3>
          ...
          <button
            ...
            className="w-full bg-slate-800 hover:bg-slate-700 text-[#1A281E] dark:text-slate-100 font-semibold py-2 rounded border border-slate-700 transition-colors"
          >
            Simular 07:00
          </button>
        </div>
        ...
        <div className="bg-white dark:bg-[#121D16] border border-[#E2E8E3] dark:border-[#1E3125]/90 p-4 rounded-lg shadow-sm space-y-2 flex flex-col justify-between">
          <div>
            ...
            <h3 className="font-bold text-[#1A281E] dark:text-slate-100 mt-2">Cobrança de Fechamento (16:30)</h3>
            <p className="text-slate-400 mt-1">
        ...
        <div className="bg-white dark:bg-[#121D16] border border-[#E2E8E3] dark:border-[#1E3125]/90 p-4 rounded-lg shadow-sm space-y-2 flex flex-col justify-between">
          <div>
            ...
            <h3 className="font-bold text-[#1A281E] dark:text-slate-100 mt-2">Prazo Limite / Cutoff (17:00)</h3>
            <p className="text-slate-400 mt-1">
      ...
      {/* Audit Log Box */}
      <div className="bg-white dark:bg-[#121D16] border border-[#E2E8E3] dark:border-[#1E3125]/90 p-4 rounded-lg shadow-sm space-y-2">
        <h3 className="font-bold text-[#1A281E] dark:text-slate-100 font-mono uppercase tracking-wider text-[11px]">
          Log de Execução do Simulador
        </h3>
        <div className="bg-[#F5F7F5] dark:bg-[#0B120E] rounded p-3 font-mono text-[11px] text-slate-300 space-y-1 max-h-48 overflow-y-auto border border-slate-800">
          {log.map((item, idx) => (
